...
def login():
    """
    Фикстура используется в тестировании для авторизации на портале YuoGile. Задает логин
    """
...
def password():
    """
    Фикстура используется в тестировании для авторизации на портале YuoGile. Задает пароль
    """
...
def company():
    """
    Фикстура используется в тестировании API. Задает наименование компании, созданной для тестирования
    """
